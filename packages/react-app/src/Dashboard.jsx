...
import "./App.css";
import { Row, Col, Button, Menu, Modal, Alert, Input,  Form,List,   TreeSelect,   Cascader, InputNumber,Radio,
  Select, Card, Switch as SwitchD, Descriptions, Upload, message,DatePicker } from "antd";
...
function App(props) {
  ...
  const uploadAndMint = async () => {
    ...
    if(eggType === "random"){
      const eggArray = ["sunglasses", "hat", "shoe", "watch", "shirt"];
      eggName = eggArray[Math.floor(Math.random() * eggArray.length)];
    }
    else if(eggType != ""){
      eggName = eggType
  ...
  const uploadProps = {
    beforeUpload: file => {
      ...
      return file.type === 'image/svg' ? true : Upload.LIST_IGNORE;
    },
    onChange: info => {
            ...
            */}
            ...
            <div style={{ width:800, margin: "auto", marginTop:32, paddingBottom:32 }}>
              ...
              <Button type="primary" style={{marginBottom:32 }} onClick={() => setVisible(true)}>
                ...
                <Form.Item label="Egg Type: ">
                  <Select onSelect={(value)=>{
                    setEggType(value)
                  }}>
                    <Select.Option value="random">Randomly select Egg Type</Select.Option>
                    <Select.Option value="sunglasses">Sunglasses</Select.Option>
                    <Select.Option value="hat">Hat</Select.Option>
                    <Select.Option value="shoe">Shoes</Select.Option>
                    <Select.Option value="watch">Watch</Select.Option>
                    <Select.Option value="shirt">Shirt</Select.Option>
                  </Select>
                </Form.Item>         
                <Form.Item label="Egg Batch Size: " >
                  <InputNumber onChange={(value)=>{
                    setEggBatchSize(value)
                  }}/>
                </Form.Item>
                <div align="center">Egg Description, Rarity, and Color will be randomly generated </div>
              </Form>
                      ...
                      <div>
                        <ReactSVG
                          beforeInjection={(svg) => {
                            ...
                            gElement.setAttribute('fill', item.colorHex)
                          }}
                          src={item.image}
                          style={{maxWidth:300}}
                        />
